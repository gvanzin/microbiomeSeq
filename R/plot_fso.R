...
#' @param method. An integer specifying method for computing similarity idices.
...
#' @param type (optional). An integer (1 or 2), for fso or mfso.
...
#' @export generateFSO
#' 
generateFSO<-function(physeq,grouping_column,method,indices=NULL,filename=NULL, type=1,step_across=F){
